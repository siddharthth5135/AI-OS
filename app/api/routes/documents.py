...
class QueryPayload(BaseModel):
    ...
    doc_ids: Optional[List[str]] = Field(default=None, description="Optional document IDs to filter search scope")
...
async def delete_document(
    ...
    await vector_service.delete_by_filter("documents", {"document_id": str(document_id)})
